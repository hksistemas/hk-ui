...
export function HKSelect({
    ...
    const [pos, setPos] =
        useState<DropdownPos | null>(null)
    ...
    /**
     * Cria um ChangeEvent compatível
     * com o padrão dos elementos HTML.
     */
    ...
    /**
     * Dispara o callback tradicional
     * e, se informado, o callback em formato
     * de evento HTML.
     */
    const emitChange = (
        newValue: string | string[]
            ...
            <button
                ...
                className={`
                    ...
                    ${
                        open
                            ? 'border-gray-400'
                            : `rounded-sm ${t.trigger}`
                    }
                    ${
                        disabled
                            ? `opacity-50 cursor-not-allowed ${t.triggerDisabled}`
                            : `cursor-pointer ${t.trigger}`
                    }
                `}
                style={triggerStyle}
            >
                {/*
                    Esta área ocupa explicitamente
                    todo o espaço disponível.
                    Não dependemos apenas do
                    flex-1 do Tailwind.
                */}
                <span
                    className="
                ...
                {/*
                    Área do lado direito.
                    flexShrink: 0 garante que
                    o Chevron nunca seja comprimido.
                */}
                <span
                    className="
                        flex
